...
- (void)awakeFromNib
{
    ...
    self.myView.backgroundColor = [UIColor colorWithRed:20 / 255.0 green:124 / 255.0 blue:204 / 255.0 alpha:0.85];
}
        ...
        if (i < firstWeekday) {
            ...
            if ([_today isEqualToDate:_date]) {
                if (day == [self day:_date]) {
                    ...
                    [cell.dateLabel setTextColor:[UIColor colorWithRed:0.1 green:0.1 blue:0.1 alpha:1]];
                }
